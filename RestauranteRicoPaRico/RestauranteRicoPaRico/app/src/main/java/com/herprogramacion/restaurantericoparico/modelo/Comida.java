...
public class Comida {
    ...
    static {
        ...
        COMIDAS_POPULARES.add(new Comida(83, "Spagetti a la Bolognesa", R.drawable.spagetti_bolognesa));
        ...
        COMIDAS_POPULARES.add(new Comida(136.5f, "Coctel de Camarones Mega", R.drawable.mega_coctel));
      ...
      PLATILLOS.add(new Comida(73, "Sopa de Tomate", R.drawable.sopa));
        ...
        PLATILLOS.add(new Comida(136.5f, "Coctel de Camarones Mega", R.drawable.mega_coctel));
        ...
        PLATILLOS.add(new Comida(83, "Spagetti a la Bolognesa", R.drawable.spagetti_bolognesa));
        ...
        PLATILLOS.add(new Comida(340f, "Lomo De Cerdo Americano", R.drawable.lomo_cerdo));
        ...
        PLATILLOS.add(new Comida(149.9f, "Carne Ahumada y Vino", R.drawable.descarga));
        PLATILLOS.add(new Comida(54.9f, "Chile Relleno", R.drawable.chile_relleno));

        BEBIDAS.add(new Comida(389, "Botella Vino Tinto Basico", R.drawable.vino_tinto));
        ...
        POSTRES.add(new Comida(57, "Coctel de Frutas", R.drawable.coctel_frutas));
